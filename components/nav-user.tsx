            ...
            <SidebarMenuItem>
                <DropdownMenu>
                        ...
                        >
                            ...
                            <div className="grid flex-1 text-left text-sm leading-tight ml-1">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    {/* 在側邊欄按鈕顯示簡短部門標籤 */}
                                    <Badge variant="outline" className={cn("px-1 py-0 h-4 text-[9px] font-black uppercase tracking-tighter", config.className)}>
                                        {config.label}
                                    </Badge>
                                </div>
                    ...
                    >
                        ...
                        <DropdownMenuItem
                            className="cursor-pointer text-destructive focus:text-destructive font-bold rounded-lg py-2"
