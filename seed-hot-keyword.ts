...
async function main() {
    ...
    // 3. 準備原始資料 (ID 由資料庫自動產生，order 依序排列)
    const rawData = [
        {
            title: '破冰船',
            linkUrl: '/search?keyword=破冰船',
            gaEvent: 'search_action',
            gaEventName: 'search_action_navigation_icebreaker_v1',
            gaCategory: 'home_navigation',
            gaLabel:
                '2026_keyword_nav_icebreaker|navigation_icebreaker_v1|always_on',
        },
        {
            title: '東京迪士尼',
        ...
        },
        {
            ...
            gaCategory: 'home_navigation',
            gaLabel:
                '2026_keyword_nav_amanohashidate|navigation_amanohashidate_v1|always_on',
        },
        {
            title: '九州湯布院',
        ...
        },
        {
            ...
            gaCategory: 'home_navigation',
            gaLabel:
                '2026_keyword_nav_shirakawago|navigation_shirakawago_v1|always_on',
        },
        {
            title: '北海道滑雪',
        ...
        },
        {
            title: '連休出國',
            linkUrl:
                'https://www.dtsgroup.com.tw/event/week/?&utm_source=website&utm_medium=display&utm_campaign=week_page_20240909&utm_content=30-50f_abc',
            gaEvent: 'search_action',
        ...
        },
        {
            ...
            gaCategory: 'home_navigation',
            gaLabel:
                '2026_keyword_nav_tateyama|navigation_tateyama_v1|always_on',
        },
    ];
